...
const PatientDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [wlRes, appRes, notRes] = await Promise.all([
          api.get('/waitlist'),
        ...
        console.error('Error al obtener datos del dashboard del paciente:', err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const nextAppointment = appointments.find(a => a.estado === 'confirmada' || a.estado === 'pendiente');
        ...
        <div className="container" style={{ padding: '2rem 1rem', maxWidth: 1100 }}>
          ...
          {loading ? (
            <div style={{ textAlign: 'center', padding: '4rem 0' }}>
              ...
              <p style={{ color: '#888' }}>Cargando información del dashboard...</p>
            </div>
          ) : (
            <>
              {/* Stat Cards */}
              <div className="row mb-4">
                ...
                <div className="col-md-3 col-6 mb-3">
                  <div className="stat-card success animate-in">
                    <div className="d-flex align-items-center" style={{ gap: '12px' }}>
                      ...
                      <div>
                        <div className="stat-value">{nextAppointment ? 1 : 0}</div>
                ...
                <div className="col-md-3 col-6 mb-3">
                  <div className="stat-card warning animate-in"
                    ...
                    <div className="d-flex align-items-center" style={{ gap: '12px' }}>
                      ...
                      <div>
                        <div className="stat-value">{completedAppts}</div>
                ...
                <div className="col-md-3 col-6 mb-3">
                  <div className="stat-card secondary animate-in"
                    onClick={() => history.push('/paciente/notificaciones')}
                    style={{ cursor: 'pointer' }}>
                    <div className="d-flex align-items-center" style={{ gap: '12px' }}>
              ...
              <div className="row">
                ...
                <div className="col-lg-7 mb-4">
                  ...
                  {waitList.length === 0 ? (
                    <div style={{
                      padding: '2.5rem 1.5rem', background: '#fff', borderRadius: 'var(--radius-lg)',
                      textAlign: 'center', boxShadow: 'var(--shadow-sm)', color: '#888'
                    }}>
                      No estás registrado en ninguna lista de espera.
                    </div>
                  ) : (
                ...
                <div className="col-lg-5">
                  ...
                  {nextAppointment ? (
                    <div style={{
                      ...
                      <div style={{ opacity: 0.9, marginBottom: '0.75rem' }}>
                        {nextAppointment.hora.substring(0, 5)} hrs — {nextAppointment.especialidad}
                      </div>
                      <div style={{
                    ...
                    <div style={{
                      ...
                      textAlign: 'center', marginBottom: '1.5rem', boxShadow: 'var(--shadow-sm)'
                    }}>
                      <span className="material-icons-outlined" style={{ fontSize: '2rem', color: '#ccc', marginBottom: '0.5rem', display: 'block' }}>
                        event_busy
                      </span>
                      <strong style={{ color: 'var(--gob-tertiary)' }}>Sin citas programadas</strong>
                      <p style={{ color: '#888', fontSize: '0.8rem', margin: '4px 0 0' }}>
                        Recibirás alertas cuando tu cita sea confirmada.
                      </p>
                    </div>
                  )}
                  ...
                  {notifications.length === 0 ? (
                    <div style={{
                      padding: '1rem', background: '#fff', borderRadius: 'var(--radius-md)',
                      textAlign: 'center', boxShadow: 'var(--shadow-sm)', color: '#888', fontSize: '0.85rem'
                    }}>
